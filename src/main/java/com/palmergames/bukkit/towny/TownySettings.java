...
public class TownySettings {
    ...
    /**
     * Loads town levels. Level format ignores lines starting with #. Each line
     * is considered a level. Each level is loaded as such:
     *
    ...
    /**
     * Loads nation levels. Level format ignores lines starting with #. Each
     * line is considered a level. Each level is loaded as such:
     *
    ...
    /*
     * public static boolean isUsingRegister() { return
     * getBoolean(ConfigNodes.PLUGIN_USING_REGISTER); }
     *
     * public static void setUsingRegister(boolean newSetting) {
     * setProperty(ConfigNodes.PLUGIN_USING_REGISTER.getRoot(), newSetting); }
     *
     * public static boolean isUsingIConomy() { return
     * getBoolean(ConfigNodes.PLUGIN_USING_ICONOMY); }
     *
    ...
    public static int getMaxResidentPlots(Resident resident) {
        //TODO configure this
        int maxPlots = getInt(ConfigNodes.TOWN_MAX_PLOTS_PER_RESIDENT);
        return maxPlots;
    }
