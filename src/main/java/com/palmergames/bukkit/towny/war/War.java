...
public class War {
        ...
        try {
            ...
            try {
                ...
                for (Nation winningNation : warringNations) {
                    ...
                    TownyMessaging.sendGlobalMessage(winningNation.getName() + " won " + TownyEconomyObject.getFormattedBalance(nationWinnings) + ".");
                }
            ...
            try {
                ...
                TownyMessaging.sendGlobalMessage(winningTownScore.key.getName() + " won " + TownyEconomyObject.getFormattedBalance(halfWinnings) + " with the score " + winningTownScore.value + ".");
            } catch (TownyException e) {
            }
    ...
    public void remove(Town attacker, TownBlock townBlock) throws NotRegisteredException {
        ...
        try {
            if (!townBlock.getTown().payTo(TownySettings.getWartimeTownBlockLossPrice(), attacker, "War - TownBlock Loss")) {
                ...
                double loss = TownySettings.getWartimeTownBlockLossPrice();
                TownyMessaging.sendTownMessage(townBlock.getTown(), "Your town lost " + TownyEconomyObject.getFormattedBalance(loss) + ".");
            }
        } catch (EconomyException e) {
        }
    ...
    public List<String> getStats() {
        ...
        if (TownySettings.isUsingEconomy()) {
            output.add(Colors.Green + "  Spoils of War: " + Colors.LightGreen + warSpoils.getHoldingFormattedBalance());
        }
